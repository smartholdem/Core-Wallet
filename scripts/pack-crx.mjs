 ...
 * - Writes the archive to `apps/extension/smartholdem-wallet-chrome-<version>.crx` and prints
...
const OUT_PATH = resolve(ROOT, `apps/extension/smartholdem-wallet-chrome-${VERSION}.crx`);
...
const crx = new ChromeExtension({
  codebase: "https://smartholdem.io/smartholdem-wallet.crx",
