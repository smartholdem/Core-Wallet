 ...
 * - Writes the archive to `apps/extension/smartholdem-wallet-<version>.crx` and prints
...
const OUT_PATH = resolve(ROOT, `apps/extension/smartholdem-wallet-${VERSION}.crx`);
